...
async function seedBlogPosts() {
  ...
  await blogDb.insertManyPosts([
    ...
    // ── POST 1 ────────────────────────────────────────────────────────────
    {
      ...
      category:     'Business',
      tags:         ['Nigeria', 'Technology', 'SEO', 'Business'],
...
<div style="background:var(--gl-card);border:1px solid var(--gl-border);border-radius:8px;padding:36px 32px;" class="mb-5">
  <div class="row align-items-center">
    ...
    // ── POST 2 ────────────────────────────────────────────────────────────
    {
      ...
      category:     'WordPress',
      tags:         ['WordPress', 'Technology', 'Business', 'Nigeria'],
...
<div style="background:var(--gl-card);border:1px solid var(--gl-border);border-radius:8px;padding:36px 32px;" class="mb-5">
  <div class="row align-items-center">
    ...
    // ── POST 3 ────────────────────────────────────────────────────────────
    {
      ...
      category:     'SEO',
      tags:         ['SEO', 'Nigeria', 'Google', 'Marketing'],
...
<div style="background:var(--gl-card);border:1px solid var(--gl-border);border-radius:8px;padding:36px 32px;" class="mb-5">
  <div class="row align-items-center">
    ...
    // ── POST 6 ────────────────────────────────────────────────────────────
    {
      slug:         'tech-career-nigeria',
      title:        'Starting a Tech Career in Nigeria: What No One Tells You',
      excerpt:      'The demand is real, the money is real \u2014 but so are the mistakes most beginners make. An honest guide from people who\'ve trained 200+ developers in Onitsha.',
      category:     'Career',
      tags:         ['Technology', 'Career', 'Nigeria', 'Academy'],
