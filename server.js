...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", "blob:", "data:", "https://api.anthropic.com", "https://api.brevo.com", "https://prod.spline.design", "https://unpkg.com", "https://viewer.spline.design", "wss:", "ws:"],
            frameSrc: ["'self'", "https://js.paystack.co", "https://prod.spline.design", "https://viewer.spline.design"],
